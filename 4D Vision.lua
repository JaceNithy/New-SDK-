--[[
    0.1 Fixed an error with Line
    0.2 4D Version
    by: Jace, Maxxed and CTTBOT
--]]

local Version4DGeometry = 0.52
local uniqueId = 0

OnTick = function()
__PrintTextGame("3. Dimension - Y Value: " .. myHero .. "\n4. Dimension - Time: " .. GetTimeGame())
end
...
class "Point"
    ...
    function Point:__addition(v)
        ...
        elseif v.type == "Point" then
            ...
            __PrintTextGame("Error on Point:__addition, value is unexpected")
        end
    end
    --[[
    ...
    function Point:__substract(v)
        ...
        elseif v.type == "Point" then
            ...
            __PrintTextGame("Error on Point:__substract, value is unexpected")
        end
    end
    --[[
        Multiply a Point
    ...
    function Point:__multiply(v)
        ...
        elseif v.type == "Point" then
            ...
            __PrintTextGame("Error on Point:__multiply, value is unexpected: ".. type(v))
        end
    end
    --[[
        Divide a Point
    ...
    function Point:__divide(v)
        ...
        elseif v.type == "Point" then
            ...
            __PrintTextGame("Error on Point:divide, value is unexpected")
        end
    end
    --[[
    ...
    function Point:__toString()
        if self.type == "Point" then
            ...
            __PrintTextGame("Error on __toString")
        end
    end
    --[[
        Clone a Point
    ...
    function Point:__ClosestPointTo(Object)
        if Object.type == "LineSegment" then
            ...
            if ((xDelta == 0) and (yDelta == 0)) then
                __PrintTextGame("Segment start equals segment end")
            end
...
class "Line"
    ...
    function Line:__contains(Object)
        ...
        elseif Object.type == "LineSegment" then
            ...
            __PrintTextGame("Error on Line:__contains, ObjectType is unexpected")
        end
    end
    --[[
    ...
    function Line:__distance(Object)
        ...
        elseif Object.type == "Point" then
            ...
            __PrintTextGame("Error on Line:__distance, ObjectType is unexpected")
        end
    end
    --[[
        Draws the Line
